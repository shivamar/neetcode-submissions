class Solution {
    public int ladderLength(String beginWord, String endWord, List<String> wordList) {
        ...
        wordListSet.add(beginWord); // as wordList can also contains beginWord , edge case is that level can be 0 if both beginWord is endWord, also we dont need to process twice to adj list
        ...
        while(!arrayDeq.isEmpty()){
            ...
            for(int k=0;k < size;k++)
            {
                ...
                {
                    List<String> nextWords = indexPatternWList.getOrDefault(patt, List.of());
